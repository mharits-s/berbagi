            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="flex flex-row gap-x-16">
                    ...
                    <div>
                        ...
                        <p class="text-slate-500 text-sm">Target: Rp{{number_format($fundraisingWithdrawal->fundraising->target_amount, 0, ',', '.')}}</p>
                    </div>
                </div>
                <hr class="my-5">
                ...
                <img src="{{Storage::url($fundraisingWithdrawal->proof)}}" alt="{{Storage::url($fundraisingWithdrawal->proof)}}" class="rounded-2xl object-cover w-[300px] h-[200px] mb-3">
                <hr class="my-5">

                <h3 class="text-indigo-950 text-xl font-bold mb-5">Eviden</h3>
                <img src="{{Storage::url($fundraisingPhase->photo)}}" alt="{{Storage::url($fundraisingPhase->photo)}}" class="rounded-2xl object-cover w-[300px] h-[200px] mb-3">
                <hr class="my-5">
                @else
