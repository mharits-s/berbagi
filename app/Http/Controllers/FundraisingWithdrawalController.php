...
class FundraisingWithdrawalController extends Controller
{
    ...
    public function store(StoreFundraisingWithdrawalRequest $request, Fundraising $fundraising)
    {
        ...
        DB::transaction(function() use ($request, $fundraising){
            ...
            $validated['proof'] = 'proof/dummy.png';
     ...
     */
    public function show(FundraisingWithdrawal $fundraisingWithdrawal, FundraisingPhase $fundraisingPhase)
    {
        //
        return view('admin.fundraising_withdrawals.show', compact('fundraisingWithdrawal', 'fundraisingPhase'));
    }
